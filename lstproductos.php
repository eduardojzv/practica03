...
<html lang="en">
    <head>
        ...
        <script>
            function sql_insertar() {
                location.href = "sql_insertar.php";
            }
        </script>
    </head>
    ...
    <main class="row contenido">
        <div class="card tarjeta">
            ...
            <div class="card-body">
                <?php
                    if($NunFilas > 0){
                        ...
                        while($Tupla = mysqli_fetch_assoc($Regis)){
                            ...
                            echo "<td align='center'><a href='sql_modificar.php?cod=".$Tupla['ProductID'].'&accion=accion01&catID='.$_GET["cod"]."'>Editar</a></td>";
                            echo "<td align='center'><a href='codes/sql_eliminar.php?cod=".$Tupla['ProductID']."&accion=accion01&catID=".$_GET["cod"]."'>Borrar</a></td>";
                            echo "</tr>";
                        }
                        echo "</tbody></table>";
                    }else{
                ...
                ?>
                <a href='sql_insertar.php?form=products&cod=<?php echo($_GET["cod"]);?>' class="btn btn-sm btn-primary">agregar Producto</a>
                <!-- <button type="button" class="btn btn-sm btn-primary" onClick="sql_insertar()">Agregar Producto</button> -->
            </div>
        </div>
    </main>
