    ...
    <main class="row contenido">
        <div class="card tarjeta">
            ...
            <div class="card-body">
                <?php
                    if($nunFilas > 0){
                        ...
                        while($Tupla = mysqli_fetch_assoc($regis)){
                            ...
                            echo "<td align='center'><a href='codes/sql_eliminar.php?cod=".$Tupla['CategoryID']."&accion=accion02"."'>Borrar</a></td>";
                            echo "</tr>";
                        }
                        echo "</tbody></table>";
                    }else{
                ...
                ?>
                <a href='sql_insertar.php?form=categories' class="btn btn-sm btn-primary">agregar Categoria</a>
